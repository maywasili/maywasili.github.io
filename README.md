...
<body>
  ...
  <nav>
    <a class="nav-logo" href="#hero">Ajim.dev</a>
    <div class="nav-right">
      <ul class="nav-links">
  ...
  <section id="hero">
    <div class="hero-top">
      ...
      <div>
        <p class="hero-tag">// Stay silent. Build loudly.</p>
        <h1 class="hero-name">Muhammad<br><span>Ajim</span></h1>
      </div>
    </div>
    <p class="hero-desc">Silent Hustler • Digital Mindset • Online Income<br>Teaching people how to win online without depending on anyone.</p>
    <div class="hero-btns">
      <a class="btn-primary" href="#projects">View My Work →</a>
      <a class="btn-outline" href="#newsletter">🎁 Get Free Guide</a>
    </div>
  ...
  <div id="counters">
    <div class="counters-inner">
      <div><div class="counter-num" data-target="500">0</div><div class="counter-label">Students Helped</div></div>
      <div><div class="counter-num" data-target="4">0</div><div class="counter-label">Digital Products</div></div>
      <div><div class="counter-num" data-target="12">0</div><div class="counter-label">Months Online</div></div>
      <div><div class="counter-num" data-target="100">0</div><div class="counter-label">% Self-Taught</div></div>
    </div>
  </div>
    ...
    <div class="about-grid">
      <div class="about-photo-wrap">
        <div class="about-photo">
          <span>📸</span>
          <small>Add your photo<br>(black shirt)</small>
        </div>
        <p class="about-photo-hint">Replace with<br>&lt;img src="you.jpg"&gt;</p>
      </div>
      <div>
        <div class="about-text">
          <p>I'm <strong>Muhammad Ajim Yusuf Wasili</strong> — a <strong>Silent Hustler</strong> with a digital-first mindset, focused on building real online income and helping others do the same.</p>
          <p>I believe in <strong>winning online without depending on anyone</strong>. Through affiliate marketing, digital products, and content creation, I've built systems that generate income around the clock.</p>
          <p>My mission: teach you the exact strategies, tools, and mindset to achieve <strong>true digital freedom</strong> — one skill at a time.</p>
        </div>
        <div class="skills-list">
          <div class="skill-item">Affiliate Marketing <span class="skill-tag">income</span></div>
          <div class="skill-item">Digital Products <span class="skill-tag">passive</span></div>
          <div class="skill-item">YouTube Content <span class="skill-tag">content</span></div>
          <div class="skill-item">Online Courses <span class="skill-tag">teaching</span></div>
          <div class="skill-item">Email Marketing <span class="skill-tag">growth</span></div>
          <div class="skill-item">Personal Branding <span class="skill-tag">identity</span></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section id="projects" class="reveal">
    <p class="section-label">02 — My Work</p>
    <div class="projects-grid">
      <a class="project-card" href="#">
        <div class="project-icon">💰</div>
        <p class="project-num">001</p>
        <h3 class="project-title">Affiliate Marketing System</h3>
        <p class="project-desc">A proven step-by-step system for earning commissions online — no product, no capital, no boss. Built for beginners who want real results.</p>
        <div class="project-tags"><span class="tag">Affiliate</span><span class="tag">Passive Income</span><span class="tag">Beginner</span></div>
      </a>
      <a class="project-card" href="#">
        <div class="project-icon">▶️</div>
        <p class="project-num">002</p>
        <h3 class="project-title">YouTube Content Channel</h3>
        <p class="project-desc">Educational videos teaching digital skills, online income strategies, and the silent hustler mindset — helping thousands take their first step online.</p>
        <div class="project-tags"><span class="tag">YouTube</span><span class="tag">Education</span><span class="tag">Content</span></div>
      </a>
      <a class="project-card" href="#">
        <div class="project-icon">📦</div>
        <p class="project-num">003</p>
        <h3 class="project-title">Digital Products Store</h3>
        <p class="project-desc">Downloadable eBooks, templates, and toolkits teaching people exactly how to start earning online. Create once, sell forever.</p>
        <div class="project-tags"><span class="tag">eBooks</span><span class="tag">Templates</span><span class="tag">Digital</span></div>
      </a>
      <a class="project-card" href="#">
        <div class="project-icon">🎓</div>
        <p class="project-num">004</p>
        <h3 class="project-title">Online Training Program</h3>
        <p class="project-desc">A structured course walking students from zero to their first online income — covering mindset, tools, strategy, and execution. No fluff.</p>
        <div class="project-tags"><span class="tag">Course</span><span class="tag">Mentorship</span><span class="tag">Training</span></div>
      </a>
    </div>
  </section>
  ...
  <div id="testimonials" class="reveal">
    <div class="testimonials-inner">
      <p class="section-label">03 — What People Say</p>
      <div class="testimonials-grid">
        <div class="testimonial-card">
          <div class="testimonial-quote">"</div>
          <p class="testimonial-text">Ajim's affiliate system is the clearest guide I've 
